...
class SpielAblaufTest {
    ...
    public void abfahrt() {
        ...
        String liga = "Landesliga Männer";
        LocalDateTime anwurf = LocalDateTime.parse("2024-04-13T15:30:00");
        SpielAblauf ablauf = new SpielAblauf(anwurf, liga, 45, config);
    ...
    public void spielEnde() {
        ...
        LocalDateTime anwurf = LocalDateTime.parse("2024-04-13T15:30:00");
        SpielAblauf ablauf = new SpielAblauf(anwurf, "", 0, config);
    ...
    public void heimkehr() {
        ...
        config.Spielablauf.UmziehenNachSpiel = 15;
        LocalDateTime anwurf = LocalDateTime.parse("2024-04-13T15:30:00");
        SpielAblauf ablauf = new SpielAblauf(anwurf, "", 45, config);
